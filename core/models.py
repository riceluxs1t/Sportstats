...
class RawMatch(models.Model):
    ...
    home_team_resulting_rating = models.IntegerField()
    away_team_resulting_rating = models.IntegerField()
    home_team_rating_change = models.IntegerField()
    away_team_rating_change = models.IntegerField()
    home_team_resulting_rank = models.IntegerField()
    away_team_resulting_rank = models.IntegerField()
